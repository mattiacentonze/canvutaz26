...
La v3.2 usa nuovi cache-buster in `index.html` e una nuova chiave `localStorage` (`usa26_v34_cache`). Se hai ancora dati vecchi, svuota la cache del sito o fai `Ctrl+F5` dopo il deploy.
